    ...
    <body id="mimin" class="dashboard">
          ...
          <div id="content">
               ...
               <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <form method="post" action="/pasien_positif/import_excel" enctype="multipart/form-data">
                    ...
                    <div class="panel-body">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td> {{$pasien -> jumlah}} </td>
                          <td>
                            <a href="/pasien-positif/{{$pasien->id}}/edit" class="btn btn-warning btn-sm" role="button">Edit</a>
                            <a href="/pasien-positif/delete/{{$pasien->id}}" class="btn btn-danger btn-sm" role="button">
      ...
      <button id="mimin-mobile-menu-opener" class="animated rubberBand btn btn-circle btn-danger">
       ...
       <!-- end: Mobile -->
        ...
        <div class="modal-body">
    <form action="/pasien-positif/create" method="POST">
