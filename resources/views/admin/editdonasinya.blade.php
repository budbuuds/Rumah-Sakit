      ...
      <div class="container-fluid mimin-wrapper">
          ...
          <div id="content">
               <div class="panel box-shadow-none content-header">
                  ...
                  @endif
                    <div class="col-md-12">
                    <form action="/donasinya-admin/{{$donasinya->id}}/update" method="POST">
                            <!-- <form action="/lensamasuk/store" method="POST"> -->
                                {{csrf_field()}}
                                <div>
                                    <label for="exampleFormControlTextarea1">Tanggal Upload</label>
                                    <input name="tanggal" class="form-control" type="date" placeholder="Default input" value="{{$donasinya->tanggal}}">
                                </div>
                                <div>
                                    <label for="exampleFormControlTextarea1">Judulnya</label>
                                    <input name="barangnya" class="form-control" type="text" placeholder="Default input" value="{{$donasinya->barangnya}}">
                                </div>
                                <div>
                                    <label for="exampleFormControlTextarea1">Linknya</label>
                                    <input name="donaturnya" class="form-control" type="text" placeholder="Default input" value="{{$donasinya->donaturnya}}">
                                </div>
                                </div>
