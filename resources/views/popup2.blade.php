            ...
            <table id="datatables-example" class="table table-bordered">
                <thead class="thead">
                    <tr>
                        ...
                        <th scope="col" rowspan="2">Faskes</th>
                        <th scope="col" rowspan="2">Alamat</th>
                        <th scope="col" colspan="3">Masker N95(pcs)</th>
                        <th scope="col" colspan="3">Masker Surgical(Box)</th>
                        <th scope="col" colspan="3">Sarung Tangan(psg)</th>
                        <th scope="col" colspan="3">Hazmat(pcs)</th>
                        <th scope="col" colspan="3">Faceshield(pcs)</th>
                        <th scope="col" colspan="3">Kacamata Goggles(pcs)</th>
                        <th scope="col" colspan="3">Boot & Shoe Cover(pcs)</th>
                        <th scope="col" colspan="3">Handsanitizer(L)</th>
                        <th scope="col" colspan="3">Desinfektan(L)</th>
                        <th scope="col" colspan="3">Multivitamin(Px)</th>
                    </tr>
                    <tr>
                        <th>Request</th>
                        <th>Donasi</th>
