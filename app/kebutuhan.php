...
class kebutuhan extends Model
{
    ...
    protected $fillable = ['rs_1_id', 'masker_n95', 'masker_surgical', 'sarung_tangan', 'coverall_jumpsuit', 'faceshield', 'kacamata_goggles', 'boot_and_shoe_cover', 'handsanitizer', 'desinfektan', 'multivitamin', 'kantong_jenazah', 'Skorlet',
    ...
    public function rs_1()
    {
        return $this->belongsTo(rs_1::class);
    }
}
